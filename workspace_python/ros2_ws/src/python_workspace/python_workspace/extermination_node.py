...
class ExterminationNode(Node):
    def __init__(self):
        ...
        # self.subscription_pointer = self.create_subscrisource install/setup.bash
    ...
    def inference_callback(self, msg):
        ...
        # out_img,named_classes, confidences, boxes = model.inference(preprocessed_img)
        ...
        cv2.waitKey(10)
        # run some other cuda stuff here
    ...
    #     cv2.putText(image, f"FPS: {round(self.fps)}", (10, 30),
