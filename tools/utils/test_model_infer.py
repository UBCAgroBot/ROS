...
# add fancy tqdm
sys.path.append(os.path.abspath('/home/user/workspace/python_wip'))
...
def export(args):
    ...
    filename = '/home/user/workspace/tools/utils/Maize.pt'
...
def test(args):
    # Load model
    model = ONNXDetect(args, onnx_path='/home/user/workspace/tools/utils/Maize.onnx')

    frame = cv2.imread('/home/user/workspace/assets/maize/IMG_1822_14.JPG')
    image = frame.copy()
    outputs = model(image)
    display_annotated_image('/home/user/workspace/assets/maize/IMG_1822_14.JPG', outputs)
